...
from base.Listner import  WebDriverWrapper
from utility import data_source
...
class TestAddEmployee(WebDriverWrapper):
    ...
    def test_invalid_profile_upload(self,username,password,upload_file,expected_error):
        ...
        self.driver.find_element(By.XPATH, "//input[@class='oxd-file-input']").send_keys(upload_file)
